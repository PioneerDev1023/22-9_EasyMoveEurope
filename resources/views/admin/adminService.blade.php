                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <!-- <input type="text" class="form-control" id="service" name="service" placeholder="Enter a service" value="" maxlength="50" required=""> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="detail" name="detail" placeholder="Enter a detail" value="" maxlength="50" required="">
                            </div>
                        </div>
