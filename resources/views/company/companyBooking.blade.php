                ...
                <div class="db-field">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Upcoming Booking</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Previous Bookings</button>
                        </li>
                    </ul>
                                        ...
                                        <div class="post-service col-lg-5 col-md-12 col-sm-12 col-12">
                                            <div class="post-serarea">
                                                <div class="post-text1">
                                                    <p class="post-title">Slot time</p>
                                                    @if($data->prefer_time == 'am')
                                                        <p class="post-cost">9:30am - 11:30am</p>
                                                    @else 
                                                        <p class="post-cost">12:30pm - 2:30pm</p>
                                                    @endif
                                                </div>
                                                <div class="post-text2">
                                                    <p class="post-title">Registration Number</p>
                                                    <p class="post-cost">{{$data->reg_number}}</p>
                                                </div>
                                                <div class="post-text3">
                                                    <p class="post-title">Price</p>
