                ...
                <div class="signup-form">
                    ...
                    <form method="POST" class="register-form" id="register-form" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="reg-text form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="Full Name">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <label for="agree_term" class="label-agree-term">
                                ...
                                <a href="/privacy" class="term-service">Terms of service</a>
                            </label>
